...
public class GamePlay : MonoBehaviour
{
    ...
    [field: SerializeField]
    public FoodDictionary FoodDictionary { get; private set; }

    [field: SerializeField]
    public FoodOrderManager FoodOrderManager { get; private set; }

    [field: SerializeField]
    public TableOrderManager TableOrderManager { get; private set; }
